...
class NominaSupraList(supra.SupraListView):
    model = models.Nomina
    list_display = ['id', 'empleado_f', 'fecha', 'salario_base', 'subsidio_trasporte', 'extras', 'extra_nocturna', 'extra_diurna', 'extra_dominical', 'prestaciones_sociales', 'salario_produccion', 'bonificacion']

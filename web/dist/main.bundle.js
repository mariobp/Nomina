...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__cargo_cargo_service__ = __webpack_require__("../../../../../src/app/configuracion/cargo/cargo.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__tipocontrato_tipocontrato_service__ = __webpack_require__("../../../../../src/app/configuracion/tipocontrato/tipocontrato.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__unidadproduccion_unidadproduccion_component__ = __webpack_require__("../../../../../src/app/configuracion/unidadproduccion/unidadproduccion.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__unidadproduccion_unidadproduccion_service__ = __webpack_require__("../../../../../src/app/configuracion/unidadproduccion/unidadproduccion.service.ts");
        ...
        path: '', children: [
            {
                path: 'cargos', component: __WEBPACK_IMPORTED_MODULE_0__cargo_cargo_component__["a" /* CargoComponent */], children: [
                    ...
                    { path: ':id/edit', component: __WEBPACK_IMPORTED_MODULE_0__cargo_cargo_component__["c" /* EditCargoComponent */], resolve: { item: __WEBPACK_IMPORTED_MODULE_4__cargo_cargo_service__["a" /* CargoService */] } }
                ]
            },
            {
            ...
            },
            {
                path: 'tipo/contrato', component: __WEBPACK_IMPORTED_MODULE_2__tipocontrato_tipocontrato_component__["a" /* TipocontratoComponent */], children: [
                    ...
                    { path: ':id/edit', component: __WEBPACK_IMPORTED_MODULE_2__tipocontrato_tipocontrato_component__["c" /* EditTipoContratoComponent */], resolve: { item: __WEBPACK_IMPORTED_MODULE_5__tipocontrato_tipocontrato_service__["a" /* TipoContratoService */] } }
                ]
            },
            {
                path: 'unidad/produccion', component: __WEBPACK_IMPORTED_MODULE_6__unidadproduccion_unidadproduccion_component__["a" /* UnidadproduccionComponent */], children: [
                    { path: '', component: __WEBPACK_IMPORTED_MODULE_6__unidadproduccion_unidadproduccion_component__["b" /* UnidadProduccionListComponent */] },
                    { path: ':id/edit', component: __WEBPACK_IMPORTED_MODULE_6__unidadproduccion_unidadproduccion_component__["c" /* EditUnidadProduccionComponent */], resolve: { item: __WEBPACK_IMPORTED_MODULE_7__unidadproduccion_unidadproduccion_service__["a" /* UnidadProduccionService */] } }
                ]
            },
            {
                path: 'tarifario', component: __WEBPACK_IMPORTED_MODULE_3__tarifario_tarifario_component__["a" /* TarifarioComponent */]
            }
        ]
    }
];
